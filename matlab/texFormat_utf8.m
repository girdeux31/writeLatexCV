...
function text = texFormat_utf8(text)
    %
    % WARNING: DO NOT save this file using windows OS
...
%             terminateProg('texFormat_utf8::forbiddenCharacter', horzcat('Forbidden character ''', c, ''' is found in line'), text_org)
%         end
%     end
    ...
    text = strrep(text, 'β', '\Shilling '); %just in case German is used
    %mathmode
